# Исходное задание организаторов, переданное пользователем

Ниже сохранён текст требований из первого сообщения этой переписки. Форматирование нормализовано; содержание требований не расширено. Дополнительные проектные решения и уточнения команды находятся отдельно в PROJECT_SPEC.md.
...
Примечание о переносе: в конце исходного сообщения пользователя стояло «часть 1». Дополнительную неизвестную часть задания не восстанавливаем и не придумываем.
